...
from run_openai_stage_b_v3_sequence_4_generation_live import run
from v3_sequence_4_generation_operator_cli import (
...
class FakeGenerationTransport:
    ...
    def request_fingerprint(self, request) -> str:
        from v3_sequence_4_generation_gate import PROVIDER_FINGERPRINT
...
def main() -> int:
    scenario = os.environ.get("GOTIME_V3_SEQUENCE_4_GENERATION_SYNTHETIC_SCENARIO", "compliant")
    owned = OwnedClient()
    transport_holder = {}
