"""Fixed sequence-4 generation operator CLI; public wrappers provide Docker isolation."""
...
def render(args) -> None:
    ...
    candidate = tomllib.loads((MANIFEST_PATH.parent / "inactive-sequence-4-generation-authorization-candidate.toml").read_text())
    artifact = {
