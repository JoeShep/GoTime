# OpenAI Response-Schema Review — V3

```text
capability: suggest_moving_service_questions
freeze date: 2026-08-07
source: MovingServiceQuestionResponseV3.model_json_schema()
...
| Response | `prompt_version` | Yes | String and exact v3 prompt literal |
| Response | `schema_version` | Yes | String and exact v3 schema literal |
| Response | `suggestions` | Yes | Array, maximum three, referenced suggestion object |
| Response | `fallback_recommended` | Yes | Boolean; prompt-v3 false policy is validated separately |
| Response | `warnings` | Yes | String array, maximum five; prompt-v3 empty policy is validated separately |
