# OpenAI Response-Schema Review — V2

```text
capability: suggest_moving_service_questions
review date: 2026-08-02
source: MovingServiceQuestionResponseV2.model_json_schema()
...
| Response | `prompt_version` | Yes | String and exact v2 prompt literal |
| Response | `schema_version` | Yes | String and exact v2 schema literal |
| Response | `suggestions` | Yes | Array, maximum three, referenced suggestion object |
| Response | `fallback_recommended` | Yes | Boolean; prompt-v2 false policy is validated separately |
| Response | `warnings` | Yes | String array, maximum five; prompt-v2 empty policy is validated separately |
