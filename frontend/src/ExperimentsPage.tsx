...
export function ExperimentsPage() {
  ...
  return (
    <main className="app-shell experiments-page py-5">
          ...
          <Card.Body className="py-4 px-0 p-sm-4 p-md-5">
            <div className="page-intro px-2 px-sm-0">
              <header className="border-bottom pb-5">
                <p className="eyebrow mb-2">GoTime experiment</p>
              ...
              <section className="pt-5" aria-labelledby="goal-heading">
                ...
                <p className="goal-name mb-0">Deterministic prototypes only</p>
                <p className="text-body-secondary mt-3 mb-0">
                  This page does not authorize AI calls, live research, or provider spending.
                </p>
              </section>
            </div>
